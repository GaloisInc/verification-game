...
Theorem WP : forall (col_1:Z) (col_0:Z) (n_2:Z) (n_1:Z) (n_0:Z) (row_1:Z)
  ...
  addr addr_WhyType)), forall (p_2:addr) (p_1:addr) (p_0:addr), let x_0 :=
  (1%Z + col_1)%Z in let x_1 := (row_1 * w_1)%Z in ((row_0 < n_0)%Z ->
  ((col_1 < w_1)%Z -> ((framed mptr_1) -> ((linked malloc_1) -> ((sconst
  mchar_2) -> ((is_uint32 col_1) -> ((is_uint32 col_0) -> ((is_uint32 n_2) ->
  ((is_uint32 n_1) -> ((is_uint32 n_0) -> ((is_uint32 row_1) -> ((is_uint32
  row_0) -> ((is_uint32 w_2) -> ((is_uint32 w_1) -> ((is_uint32 w_0) ->
  ((is_uint32 x_0) -> ((p_galois'rows_width'P malloc_1 mptr_1 mchar_2 mint_1
  p_2 n_2 w_2) -> ((valid_rw malloc_2 (shift p_1
  (to_uint32 (col_1 + (to_uint32 x_1))%Z)) 1%Z) -> ((p_galois'rows_width'I1
  malloc_2 mptr_2 mchar_1 mint_2 malloc_1 mptr_1 mchar_2 mint_1 p_2 n_2 w_2
  row_1 col_1 p_1 n_1 w_1) -> ((p_galois'rows_width'I2 malloc_0 mptr_0
  mchar_0 mint_0 malloc_1 mptr_1 mchar_2 mint_1 p_2 n_2 w_2 row_0 col_0 p_0
  n_0 w_0) -> (p_galois'rows_width'I1 malloc_2 mptr_2 (map.Map.set mchar_1
  (shift p_1 (col_1 + x_1)%Z) 0%Z) mint_2 malloc_1 mptr_1 mchar_2 mint_1 p_2
  n_2 w_2 row_1 x_0 p_1 n_1 w_1))))))))))))))))))))).
intros col_1 col_0 n_2 n_1 n_0 row_1 row_0 w_2 w_1 w_0 malloc_2 malloc_1
malloc_0 mchar_2 mchar_1 mchar_0 mint_2 mint_1 mint_0 mptr_2 mptr_1 mptr_0
p_2 p_1 p_0 x_0 x_1 h1 h2 h3 h4 h5 h6 h7 h8 h9 h10 h11 h12 h13 h14 h15 h16
h17 h18 h19 h20.
