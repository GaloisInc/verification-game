...
Theorem WP : forall (col_0:Z) (n_1:Z) (n_0:Z) (row_0:Z) (w_1:Z) (w_0:Z),
  ...
  forall (p_1:addr) (p_0:addr), (row_0 < n_0)%Z -> ((framed mptr_1) ->
  ...
  w_0) -> (p_galois'rows_width'I1 malloc_0 mptr_0 mchar_0 mint_0 malloc_1
  mptr_1 mchar_1 mint_1 p_1 n_1 w_1 row_0 0%Z p_0 n_0 w_0)))))))))))).
