...
Theorem WP : forall (col_1:Z) (col_0:Z) (n_2:Z) (n_1:Z) (n_0:Z) (row_1:Z)
  ...
  (1%Z + row_1)%Z in ((row_0 < n_0)%Z -> ((16%Z <= col_1)%Z -> ((framed
  mptr_2) -> ((linked malloc_2) -> ((sconst mchar_2) -> ((is_uint32 col_1) ->
  ((is_uint32 col_0) -> ((is_uint32 n_2) -> ((is_uint32 n_1) -> ((is_uint32
  n_0) -> ((is_uint32 row_1) -> ((is_uint32 row_0) -> ((is_uint32 w_2) ->
  ((is_uint32 w_1) -> ((is_uint32 w_0) -> ((is_uint32 x_0) ->
...
p_2 p_1 p_0 x_0 h1 h2 h3 h4 h5 h6 h7 h8 h9 h10 h11 h12 h13 h14 h15 h16 h17
h18 h19.
