...
Definition p_galois'rows_width'Q
  (_ : @map.Map.map Z _ Z _)
  (_ : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (_ : @map.Map.map addr addr_WhyType Z _)
  (_ : @map.Map.map addr addr_WhyType Z _)
  (_ : @map.Map.map Z _ Z _)
  (_ : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (_ : @map.Map.map addr addr_WhyType Z _)
  (_ : @map.Map.map addr addr_WhyType Z _)
  (_ : addr) (_ : Z) (_ : Z) : Prop := True.

Definition p_galois'rows_width'P
  (malloc_1 : @map.Map.map Z _ Z _)
  (_ : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (_ : @map.Map.map addr addr_WhyType Z _)
  (_ : @map.Map.map addr addr_WhyType Z _)
  (p_2 : addr) (n_2 : Z) (w_2 : Z) : Prop :=
  valid_rw malloc_1 p_2 (n_2 * w_2) /\ (0 < n_2)%Z /\ (0 < w_2)%Z /\ (0 < base p_2)%Z.

Definition p_galois'rows_width'I1
  (malloc_2 : @map.Map.map Z _ Z _)
  (mptr_1 : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (mchar_1 : @map.Map.map addr addr_WhyType Z _)
  (mint_1 : @map.Map.map addr addr_WhyType Z _)
  (malloc_1 : @map.Map.map Z _ Z _)
  (mptr_2 : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (mchar_2 : @map.Map.map addr addr_WhyType Z _)
  (mint_2 : @map.Map.map addr addr_WhyType Z _)
  (p_2 : addr) (n_2 : Z) (w_2 : Z) (row_1 : Z) (col_1 : Z)
  (p_1 : addr) (n_1 : Z) (w_1 : Z) : Prop :=
  valid_rw malloc_1 p_2 (n_2 * w_2) /\ p_1 = p_2 /\ w_1 = w_2 /\ n_1 = n_2 /\ (row_1 < n_2)%Z /\ (0 < base p_2)%Z /\ malloc_1 = malloc_2.

Definition p_galois'rows_width'I2
  (malloc_0 : @map.Map.map Z _ Z _)
  (mptr_0 : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (mchar_0 : @map.Map.map addr addr_WhyType Z _)
  (mint_0 : @map.Map.map addr addr_WhyType Z _)
  (malloc_1 : @map.Map.map Z _ Z _)
  (mptr_2 : @map.Map.map addr addr_WhyType addr addr_WhyType)
  (mchar_2 : @map.Map.map addr addr_WhyType Z _)
  (mint_2 : @map.Map.map addr addr_WhyType Z _)
  (p_2 : addr) (n_2 : Z) (w_2 : Z) (row_0 : Z) (col_0 : Z)
  (p_0 : addr) (n_0 : Z) (w_0 : Z) : Prop :=
  valid_rw malloc_1 p_2 (n_2 * w_2) /\ p_0 = p_2 /\ w_0 = w_2 /\ n_0 = n_2 /\ (0 < base p_2)%Z /\ malloc_0 = malloc_1 /\ (col_0 < w_2)%Z.

Lemma pos_to_uint32 : forall (x:Z), (0 <= (to_uint32 x))%Z.
  intros x.
  assert (is_uint32 (to_uint32 x)).
  auto using is_to_uint32.
  apply is_uint32_def.
  assumption.
Qed.

Lemma lt_inc_off :
  forall (x:Z) (y:Z) (z:Z) (w:Z),
    (x <= y /\ z + y <= w -> z + x <= w)%Z.
  intros x y z w.
  omega.
Qed.
...
(* Why3 goal *)
Theorem WP : forall (col_1:Z) (col_0:Z) (n_2:Z) (n_1:Z) (n_0:Z) (row_1:Z)
  (row_0:Z) (w_2:Z) (w_1:Z) (w_0:Z), forall (malloc_2:(@map.Map.map Z _ Z _))
  (malloc_1:(@map.Map.map Z _ Z _)) (malloc_0:(@map.Map.map Z _ Z _)),
  forall (mchar_2:(@map.Map.map addr addr_WhyType Z _))
  (mchar_1:(@map.Map.map addr addr_WhyType Z _)) (mchar_0:(@map.Map.map
  addr addr_WhyType Z _)) (mint_2:(@map.Map.map addr addr_WhyType Z _))
  (mint_1:(@map.Map.map addr addr_WhyType Z _)) (mint_0:(@map.Map.map
  addr addr_WhyType Z _)), forall (mptr_2:(@map.Map.map addr addr_WhyType
  addr addr_WhyType)) (mptr_1:(@map.Map.map addr addr_WhyType
  addr addr_WhyType)) (mptr_0:(@map.Map.map addr addr_WhyType
  addr addr_WhyType)), forall (p_2:addr) (p_1:addr) (p_0:addr),
  (row_0 < n_0)%Z -> ((col_1 < w_0%Z)%Z -> ((framed mptr_2) -> ((linked
  malloc_1) -> ((sconst mchar_2) -> ((is_uint32 col_1) -> ((is_uint32
  col_0) -> ((is_uint32 n_2) -> ((is_uint32 n_1) -> ((is_uint32 n_0) ->
  ((is_uint32 row_1) -> ((is_uint32 row_0) -> ((is_uint32 w_2) -> ((is_uint32
  w_1) -> ((is_uint32 w_0) ->
  ((p_galois'rows_width'P malloc_1 mptr_2 mchar_2 mint_2 p_2 n_2 w_2) ->
  ((p_galois'rows_width'I1 malloc_2 mptr_1 mchar_1 mint_1 malloc_1 mptr_2 mchar_2 mint_2 p_2 n_2 w_2 row_1 col_1 p_1 n_1 w_1) ->
  ((p_galois'rows_width'I2 malloc_0 mptr_0 mchar_0 mint_0 malloc_1 mptr_2 mchar_2 mint_2 p_2 n_2 w_2 row_0 col_0 p_0 n_0 w_0) ->
  (valid_rw malloc_2 (shift p_1 (to_uint32 (col_1 + (to_uint32 (row_1 * w_1)%Z))%Z)) 1%Z)))))))))))))))))).
  intros col_1 col_0 n_2 n_1 n_0 row_1 row_0 w_2 w_1 w_0 malloc_2 malloc_1 malloc_0 mchar_2 mchar_1 mchar_0 mint_2 mint_1 mint_0 mptr_2 mptr_1 mptr_0
p_2 p_1 p_0 h1 h2 h3 h4 h5 h6 h7 h8 h9 h10 h11 h12 h13 h14 h15 h16 h17 h18. (* TRIV: introducing variables *)
  unfold p_galois'rows_width'P in h16.  (* TRIV: unfolding *)
  unfold p_galois'rows_width'I1 in h17. (* TRIV: unfolding *)
  unfold p_galois'rows_width'I2 in h18. (* TRIV: unfolding *)
  unfold valid_rw in h16.               (* TRIV: unfolding *)
  unfold valid_rw.                      (* TRIV: unfolding *)
  unfold shift.                         (* TRIV: unfolding *)
  intros triv1.                         (* TRIV: introducing variables *)
  simpl.                                (* TRIV: unfolding *)
  destruct h16.                         (* TRIV: conjunction *)
  destruct H.                           (* TRIV: conjunction *)
  destruct H0.                          (* TRIV: conjunction *)
  destruct H0.                          (* TRIV: conjunction *)
  apply Z.mul_pos_pos.                  (* RULE: 0 < x /\ 0 < y -> 0 < x * y *)
  assumption.                           (* TRIV: assumption *)
  assumption.                           (* TRIV: assumption *)
  split.                                (* TRIV: conjunction *)
  destruct h17.                         (* TRIV: conjunction *)
  destruct H3.                          (* TRIV: conjunction *)
  rewrite -> H3.                        (* REW: equality *)
  assumption.                           (* TRIV: assumption *)
  split.                                (* TRIV: conjunction *)
  destruct H1.                          (* TRIV: conjunction *)
  destruct h17.                         (* TRIV: conjunction *)
  destruct H4.                          (* TRIV: conjunction *)
  rewrite -> H4.                        (* REW: equality *)
  assert (0 <= (to_uint32 (col_1 + to_uint32 (row_1 * w_1))))%Z.
  apply pos_to_uint32.
  apply Z.add_nonneg_nonneg.            (* RULE: 0 <= x /\ 0 <= y -> 0 <= x + y *)
  assumption.                           (* TRIV: assumption *)
  assumption.                           (* TRIV: assumption *)
  destruct h17.                         (* TRIV: conjunction *)
  destruct H3.                          (* TRIV: conjunction *)
  rewrite -> H3.                        (* REW: equality *)
  destruct H4.                          (* TRIV: conjunction *)
  destruct H5.                          (* TRIV: conjunction *)
  destruct H6.                          (* TRIV: conjunction *)
  destruct H7.                          (* TRIV: conjunction *)
  rewrite <- H8.                        (* REW: equality *)
  destruct H1.                          (* TRIV: conjunction *)
  replace (offset p_2 + to_uint32 (col_1 + to_uint32 (row_1 * w_1)) + 1)%Z with
          (offset p_2 + (to_uint32 (col_1 + to_uint32 (row_1 * w_1)) + 1))%Z.
  assert (to_uint32 (col_1 + to_uint32 (row_1 * w_1)) + 1 <= n_2 * w_2)%Z.
  rewrite -> H4.                        (* REW: equality *)
  assert (is_uint32 (row_1 * w_2))%Z.
  rewrite -> is_uint32_def.             (* TRIV: unfolding *)
  split.                                (* TRIV: conjunction *)
  rewrite -> is_uint32_def in h11.      (* TRIV: unfolding *)
  destruct h11.                         (* TRIV: conjunction *)
  rewrite -> is_uint32_def in h13.      (* TRIV: unfolding *)
  destruct h13.                         (* TRIV: conjunction *)
  apply Z.mul_nonneg_nonneg.            (* RULE: 0 <= x /\ 0 <= y -> 0 <= x * y *)
  assumption.                           (* TRIV: assumption *)
  assumption.                           (* TRIV: assumption *)
  admit.                                (* SKIP: overflow check *)
  assert (is_uint32 (col_1 + (row_1 * w_2)))%Z.
  rewrite -> is_uint32_def.             (* TRIV: unfolding *)
  split.                                (* TRIV: conjunction *)
  apply Z.add_nonneg_nonneg.            (* RULE: 0 <= x /\ 0 <= y -> 0 <= x + y *)
  rewrite -> is_uint32_def in h6.       (* TRIV: unfolding *)
  destruct h6.                          (* TRIV: conjunction *)
  assumption.                           (* TRIV: assumption *)
  apply Z.mul_nonneg_nonneg.            (* RULE: 0 <= x /\ 0 <= y -> 0 <= x * y *)
  rewrite -> is_uint32_def in h11.      (* TRIV: unfolding *)
  ...
  assumption.                           (* TRIV: assumption *)
  admit.                                (* SKIP: overflow check *)
  rewrite -> is_uint32_def in H10.      (* TRIV: unfolding *)
  rewrite -> is_uint32_def in H11.      (* TRIV: unfolding *)
  rewrite id_uint32.
  rewrite id_uint32.
  assert (col_1 + row_1 * w_2 < n_2 * w_2)%Z.
  apply row_col_range.
  split.                                (* TRIV: conjunction *)
  destruct h18.                         (* TRIV: conjunction *)
  destruct H13.                         (* TRIV: conjunction *)
  destruct H14.                         (* TRIV: conjunction *)
  rewrite <- H14.                       (* REW: equality *)
  assumption.                           (* TRIV: assumption *)
  assumption.                           (* TRIV: assumption *)
  omega.
  assumption.                           (* TRIV: assumption *)
  ...
  assumption.                           (* TRIV: assumption *)
  assumption.                           (* TRIV: assumption *)
  apply lt_inc_off with (y := (n_2*w_2)%Z)
                        (z := offset p_2)
                        (w := Map.get malloc_1 (base p_2)).
  split.                                (* TRIV: conjunction *)
  assumption.                           (* TRIV: assumption *)
  assumption.                           (* TRIV: assumption *)
  omega.
